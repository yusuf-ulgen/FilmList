...
import com.yusufulgen.filmlist.databinding.ActivityCategoriesBinding
import com.yusufulgen.filmlist.ui.home.HomeScreen
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.continueButton.setOnClickListener {
            if (viewModel.isSelectionValid()) {
                ...
                val intent = Intent(this, com.yusufulgen.filmlist.MainActivity::class.java)
